...
const benefits: BenefitItem[] = [
  {
    emoji: '⚖️',
    title: 'Komfort és súly egyensúlyban',
    body: 'Nem a legkönnyebb felszerelést hajszoljuk — a hozzád passzolót. Minden darab mellé ott a mérleg: hány gramm, hány kényelmes éjszaka.',
  },
  {
    emoji: '🗺️',
